          ...
          <div className="space-y-2">
            {user ? (
              <>
                {monthlyPriceId && (
                  <button
                    ...
                    disabled={!!loading}
                    className="w-full px-4 py-2.5 text-xs font-semibold text-black bg-yellow-400 rounded-xl hover:bg-yellow-300 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                  >
                ...
                {yearlyPriceId && (
                  <button
                    ...
                    disabled={!!loading}
                    className="w-full px-4 py-2.5 text-xs font-semibold text-yellow-400 bg-yellow-400/10 border border-yellow-400/20 rounded-xl hover:bg-yellow-400/20 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                  >
              ...
              <button
                ...
                className="w-full px-4 py-2.5 text-xs font-semibold text-black bg-yellow-400 rounded-xl hover:bg-yellow-300 transition-colors flex items-center justify-center gap-2"
              >
                <Crown className="w-3.5 h-3.5" />
            ...
            <button
              onClick={onClose}
              className="w-full px-4 py-2 text-xs text-foreground-faint hover:text-foreground transition-colors"
            >
              Maybe Later
            </button>
          </div>
